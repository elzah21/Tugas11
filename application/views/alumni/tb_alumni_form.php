!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <h2 style="margin-top:0px">Add alumni <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="jk">Jk <?php echo form_error('jk') ?></label>
            <textarea class="form-control" rows="3" name="jk" id="jk" placeholder="Jk"><?php echo $jk; ?></textarea>
        </div>
	    <div class="form-group">
