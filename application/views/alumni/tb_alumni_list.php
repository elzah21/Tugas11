      ...
      <div class="container-fluid">
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="250px">
				<?php 
				echo anchor(site_url('alumni/read/'.$alumni->id),'Detal','class="btn btn-primary"'); 
				echo anchor(site_url('alumni/update/'.$alumni->id),'Update','class="btn btn-warning"'); 
				echo anchor(site_url('alumni/delete/'.$alumni->id),'Delete','class="btn btn-danger"','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
