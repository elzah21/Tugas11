      ...
      <div class="container-fluid">
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="250px">
				<?php 
				echo anchor(site_url('b_tamu/read/'.$b_tamu->id),'Read','class="btn btn-primary"'); 
				echo anchor(site_url('b_tamu/update/'.$b_tamu->id),'Update','class="btn btn-warning"'); 
				echo anchor(site_url('b_tamu/delete/'.$b_tamu->id),'Delete','class="btn btn-danger"','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
