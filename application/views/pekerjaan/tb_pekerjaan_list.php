      ...
      <div class="container-fluid">
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="250px">
				<?php 
				echo anchor(site_url('pekerjaan/read/'.$pekerjaan->id_pekerjaan),'Read','class="btn btn-primary"'); 
				echo anchor(site_url('pekerjaan/update/'.$pekerjaan->id_pekerjaan),'Update','class="btn btn-warning"'); 
				echo anchor(site_url('pekerjaan/delete/'.$pekerjaan->id_pekerjaan),'Delete','class="btn btn-danger"','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
